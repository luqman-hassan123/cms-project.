...
const AssignPermissionToRoles = require("./assignPermissionToRole");
const AssignRolesToUser = require("./assignRolesToUser");
...
function setupRelationships() {
  ...
  userRole.belongsToMany(permission, {through: AssignPermissionToRoles,foreignKey: "userRoleId",otherKey: "permissionId",});
  permission.belongsToMany(userRole, {through: AssignPermissionToRoles,foreignKey: "permissionId",otherKey: "userRoleId",});
  // user and userRole relationship
  user.belongsToMany(userRole, {through: AssignRolesToUser,foreignKey: "userId",otherKey: "userRoleId",});
  userRole.belongsToMany(user, {through: AssignRolesToUser,foreignKey: "userRoleId",otherKey: "userId",});
}
