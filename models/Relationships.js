...
function setupRelationships() {
  ...
  Department.hasMany(Driver, {
    foreignKey: "departmentId",
    onDelete: "CASCADE",
  });
  Driver.belongsTo(Department, { foreignKey: "departmentId" });
  // Car-Driver Reservation Relationship
  Car.hasMany(CarDriverReservation, {
    foreignKey: "carId",
    onDelete: "CASCADE",
  });
  Driver.hasMany(CarDriverReservation, {
    foreignKey: "driverId",
    onDelete: "CASCADE",
  });
  ...
  Employee.hasMany(carEmployeeHistory, {
  ...
  Employee.hasMany(employeeCarAllocation, {
    foreignKey: "employeeId",
    onDelete: "CASCADE",
  });
  Car.hasMany(employeeCarAllocation, {
    foreignKey: "carId",
    onDelete: "CASCADE",
  });
  ...
  Driver.hasMany(DriverCarHistory, {
    foreignKey: "driverId",
    onDelete: "CASCADE",
  });
